...
export default function PlanningJournalier() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && id) {
      const url = new URL(`/admin/planning/vue/${id}`, window.location.origin)
    ...
    <div className="p-4 max-w-6xl mx-auto">
      ...
      {!readOnly && (
        <div className="flex flex-wrap justify-between items-center mb-6 gap-3">
          <Link href="/admin/planning/vue" className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium transition-colors">
            ← Retour sur la liste des Plannings
          </Link>
          <Link href="/admin/planning/new" className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium transition-colors">
