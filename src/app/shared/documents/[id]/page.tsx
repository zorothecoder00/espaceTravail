...
export default function DocumentDetailPage() {
  ...
  if (!doc) return <p className="text-red-600">Document introuvable ou accès refusé</p>
        ...
        <CardContent className="space-y-2 pt-4">
          ...
          {doc.fichier && (
            <p>
              ...
              <a href={doc.fichier} target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
                📄 Voir le fichier
              </a>
            </p>
          )}
          <p><strong>Créé le :</strong> {new Date(doc.createdAt).toLocaleDateString("fr-FR")}</p>
        </CardContent>
      </Card>
